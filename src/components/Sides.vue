<template>
  <div class="menu">
    <div class="navbar">
      ...
      <h1>SIDES</h1>
      <h2 style="position:relative; left:40px; top:-80px;"><i>Not the star of the show, but these would fool you.</i></h2>
      <p style="position:relative; left:60px; top:-100px;"> Some of the crispiest fries, or the juiciest vegitables. We have everything.
        <br> They'll keep you coming back.</p>
  </div>  
              ...
              <div class="col col-12 col-md-10 d-none d-xl-block d-lg-block d-md-block">
                  <table class="table table-hover" style="overflow-y: auto" :headers="headers">
                      ...
                      <template v-for="food in Menu" :key="food.MenuID">
                          <tr v-if="food && food.foodCategory === 'Sides'">
