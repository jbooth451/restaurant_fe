<template>
  <div class="menu">
      ...
      <h2 style="position:relative; left:40px; top:-80px;"><i>The stars of the show.</i></h2>
      <p style="position:relative; left:60px; top:-100px;"> Some of the best Burgers and Sandwiches in town.
        <br> Check out our Signature Burgers!</p>
  </div>  
              ...
              <div class="col col-12 col-md-10 d-none d-xl-block d-lg-block d-md-block">
                  <table class="table table-hover" style="overflow-y: auto" :headers="headers">
                      ...
                      <template v-for="food in Menu" :key="food.MenuID">
                          <tr v-if="food && food.foodCategory === 'Sandwiches & Burgers'">
