<template>
  <div class="menu">
    <div class="navbar">
      ...
      <h1>MAIN ENTREES</h1>
      <h2 style="position:relative; left:40px; top:-80px;"><i>Welcome to flavortown.</i></h2>
      <p style="position:relative; left:60px; top:-100px;"> Includes all the best of our best.
        <br> We cover a wide variety, feel free to experiment!</p>
  </div>  
              ...
              <div class="col col-12 col-md-10 d-none d-xl-block d-lg-block d-md-block">
                  <table class="table table-hover" style="overflow-y: auto" :headers="headers">
                      ...
                      <template v-for="food in Menu" :key="food.MenuID">
                          <tr v-if="food && food.foodCategory === 'Main Entrees'">
