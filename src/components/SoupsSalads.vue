<template>
  <div class="menu">
    <div class="navbar">
      ...
      <h2 style="position:relative; left:40px; top:-80px;"><i>Something before your main meal.</i></h2>
      <p style="position:relative; left:60px; top:-100px;"> Doesn't matter whether you prefer soup or salad, we got both!
        <br> Don't skimp out on a great start to your meal.</p>
  </div>  
              ...
              <div class="col col-12 col-md-10 d-none d-xl-block d-lg-block d-md-block">
                  <table class="table table-hover" style="overflow-y: auto" :headers="headers">
                      ...
                      <template v-for="food in Menu" :key="food.MenuID">
                          <tr v-if="food && food.foodCategory === 'Soups and Salads'">
